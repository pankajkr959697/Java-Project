            ...
            <div class="collapse navbar-collapse " id="collapsibleNavbar"  >
              <ul class="navbar-nav mx-auto ">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a class="nav-link text-secondary"  href="" data-toggle="modal" data-target="#SignUpModal">User-Sign Un</a>
                </li>
                <li class="nav-item">
            ...
            <div class="container">
              <div class="row align-items-center" >
                ...
                <div class="col-sm-4 bg-danger text-center p-4" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <span>  Car <input type="radio"  id="pwd" name="category" value='Car' checked /></span>
                  <span>  Bike <input type="radio" id="pwd" name="category" value='Bike'/></span>
                ...
                <form action="UserLogin" method="post">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter User Email id" id="email" name="email" required>
                  </div>
                  <div class="form-group">
                    <label for="pwd">Password:</label>
                    <input type="password" class="form-control" placeholder="Enter password" id="pwd" name="password" required>
